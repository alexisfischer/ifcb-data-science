...
[w1, z1] = meshgrid(linspace(corners(1,1), corners(2,1), 50), ...
    linspace(corners(1,2), corners(2,2), 10));

% Create 10 vertical lines containing 50 points each.
[w2, z2] = meshgrid(linspace(corners(1,1), corners(2,2), 10), ...
    linspace(corners(1,2), corners(2,2), 50));
