function [classcount, classcount_above_optthresh, classcount_above_adhocthresh] = count_class_cells_byfile(classfile, adhocthresh)
%function [classcount, classcount_above_optthresh, classcount_above_adhocthresh] = count_class_cells_byfile(classfile, adhocthresh)
...
%
% modified from H. Sosik's summarize_TBclass
